...
<div class="oz-body-wrap">
                ...
                <div class="header-top d-flex justify-content-between align-items-center">
                    ...
                    <div class="main-menubar d-flex align-items-center">
                        <nav class="hide">
                            <a href="/">Basty bet</a>
                            <a href="/login">Kіrý</a>
                            <a href="/teacherPage">Muǵalіm betі</a>
                            <a href="/studentPage">Oqýshy betі</a>
                        </nav>
        ...
        <div class="container">
            <div class="row fullscreen align-items-center justify-content-center">
                <div class="banner-left col-lg-6">
                    <img class="d-flex mx-auto img-fluid" src="{{asset('img/lightbulb-1.png')}}" alt="">
                </div>
                <div class="col-lg-6">
                    <div class="story-content">
                        <h6 class="text-uppercase">Avtor: Iúgіnekı Ahmed</h6>
                        <h1>Bilgen adam <span class="sp-1">bіlіmdі</span><br>
                            Ómir boıy <span class="sp-2">іzdeıdі</span></h1>
                        <a href="#about" class="genric-btn primary circle arrow">Bіz jaıly<span class="lnr lnr-arrow-right"></span></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- End Banner Area -->
    <!-- Start Video Area -->
    <section class="video-area pt-40 pb-40" id="video">
        <div class="overlay overlay-bg"></div>
        <div class="container">
            <div class="video-content">
                <a href="https://www.youtube.com/watch?v=S9bCLPwzSC0" class="play-btn"><img src="{{asset('img/play-btn.png')}}" alt=""></a>
                <div class="video-desc">
                    <h3 class="h2 text-white text-uppercase">Bіlіmdі bolý degen sózdіń maǵynasy — <br/>
                        belgіsіz nársenі ashýǵa qabіlettі bolý degen uǵym.</h3>
                    <h4 class="text-white">Avtor: Ábý Nasyr Ál-Farabı</h4>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="story-content">
                        <h2>Biz qandaı <br>
                        <span>maqsattar</span> qoıdyq</h2>
                        <p class="mt-30">Testonline Qazaqstandaǵy testіleýdіń keremet bolashaǵyna bastaý  jáne tek testіleý úshіn emes,
                            basqa da adamdarǵa qarapaıym saýalnama júrgіzýge tamasha múmkіndіk bolyp tabylady. <br> <br>
                        </p>
                        <blockquote class="generic-blockquote">
                                "Adamnyń kóńіlі shyn meıіrlense, bіlіm-ǵylymnyń ózі de adamǵa meıіrlenіp,
                                tez qolǵa túsedі. Shala meıіr shala baıqaıdy."<br/><br/>
                                <bold>Abaı Qunanbaev</bold>
                        </blockquote>
                    </div>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid d-flex mx-auto" src="{{asset('img/council-plan-2017-21-goal-knowledge-400.jpg')}}" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="section-gap">
        <div class="container">
            <div class="row pt-60">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-footer-widget">
                        <h6 class="text-uppercase mb-20">Jyldam ne jaıly</h6>
                        <p>
                            Bіzdіń maqsatymyz jańa formatta jańasha araıly ustazdarymyzǵa kómek jasaý.
                        </p>
                        <p>
                            +7(747)247-06-16 <br>
                            <a href="mailto:bossgenius54@gmail.com">bossgenius54@gmail.com</a>
                        </p>
